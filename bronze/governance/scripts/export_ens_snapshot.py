...
def main():
    print("Fetching ENS proposals …")
    proposals = fetch_proposals()
    print(f"Total proposals: {len(proposals)}\n")

    # ── Proposals CSV ──────────────────────────────────────────────
    with open("ens_proposals.csv", "w", newline="", encoding="utf-8") as f:
        w = csv.writer(f)
        w.writerow([
    ...
    print("Saved ens_proposals.csv")

    # ── Votes CSV ──────────────────────────────────────────────────
    with open("ens_votes.csv", "w", newline="", encoding="utf-8") as f:
        w = csv.writer(f)
        w.writerow([
